 ...
 */
/**
 * L'ONGLET DÉFI (l’arène), construit dès l'ouverture de l'app et gardé vivant,
 ...
 * `app/defi/page.tsx` ne porte que le titre. Voir `lib/nav-tabs`
 * (`ongletVivant`) et `docs/latence.md`.
 */
export default async function OngletDefi() {
  ...
  if (user) {
    ...
    const apercuAmis = mapFriendsOverview(
  ...
  const menuItems: OrbItem[] = [
    ...
    },
    {
      ...
      // comme un doublon).
      //
      // LA LIGUE VIT DANS L'ONGLET AMIS depuis le 24/09/2026 (la ligue de la
      // semaine façon Duolingo, lib/ligue) : l'entrée y mène au lieu d'ouvrir
      // l'ancienne feuille, qui en faisait une seconde, concurrente.
      id: 'ligue',
      label: 'Ligue',
    ...
    },
    {
      ...
      // « Coffre du clan » depuis le 24/09/2026 : « coffre d'équipe » est
      // désormais celui des amis (onglet Amis, migration 379).
      label: "Coffre du clan",
