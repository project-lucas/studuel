...
| **pero** | **Oppose** sans rectifier | *No es rico pero es feliz* |`,
          ...
          questions: [
            ...
            ['*___ fumo* : je ne fume plus.', ['Ya no', 'Todavía no', 'Nunca', 'Ni'], 0, '*Ya no* marque l’arrêt ; *todavía no* signifie « pas encore ».', 'Comment dit-on « ne… plus » ?'],
            ['*No es francés ___ español.*', ['sino', 'pero', 'porque', 'aunque'], 0, 'Après une négation, on rectifie avec *sino*. *Pero* oppose sans rectifier.', 'Après une négation, pour rectifier, on emploie…'],
            ['« Ninguno » s’apocope en « ningún » devant un masculin singulier.', ['Vrai', 'Faux'], 0, '*Ningún libro*, mais *ninguna casa* et *ninguno de ellos*.'],
            ['*No canta ___ grita.*', ['sino que', 'sino', 'sino de', 'pero que'], 0, 'Devant un VERBE CONJUGUÉ, *sino* devient *sino que*.', 'Devant un verbe conjugué, « sino » devient…'],
          ],
        },
        {
...
Une phrase entière ne se reprend jamais par *el que* : toujours par le neutre *lo que*.`,
          ...
          questions: [
            ...
            ['*No conozco a nadie que ___ ruso.*', ['hable', 'habla', 'hablar', 'hablará'], 0, 'La négation rend l’antécédent inexistant, donc indéfini : subjonctif.', 'Après « No conozco a nadie que… », le verbe est…'],
            ['*Llegó tarde, ___ me molestó.*', ['lo que', 'el que', 'quien', 'cuyo'], 0, 'Le neutre *lo que* reprend une idée entière, pas un nom.', 'Pour renvoyer à une idée entière, on emploie…'],
...
Les deux formes, en *-ra* et en *-se*, sont **équivalentes**.`,
          ...
          questions: [
            ...
            ['*Es necesario que ___ más.*', ['estudies', 'estudias', 'estudiar', 'estudiarás'], 0, 'Le jugement impersonnel commande le subjonctif.', 'Après « Es necesario que… », on emploie…'],
...
*en aquel entonces* (à cette époque-là) · *ni esto ni aquello* (ni l’un ni l’autre).`,
          ...
          questions: [
            ...
            ['*¿Qué es ___?* — « qu’est-ce que c’est ? »', ['esto', 'este', 'ésta', 'ese'], 0, 'On désigne une chose non identifiée : c’est le NEUTRE *esto*.', 'Comment traduire « qu’est-ce que c’est ? » ?'],
...
| *entre, según, excepto, salvo, incluso* | On garde *yo* et *tú* | *entre tú y yo*, *según tú* |`,
          ...
          questions: [
            ...
            ['*Este regalo es para ___.*', ['mí', 'yo', 'me', 'mi'], 0, 'Après préposition, le pronom tonique *mí* — avec accent, sinon c’est le possessif.', 'Comment traduire « pour moi » ?'],
            ['« Conmigo » et « contigo » sont des formes soudées irrégulières.', ['Vrai', 'Faux'], 0, 'On ne dit jamais « con mí » ni « con ti ».'],
            ['*Según ___, la película es buena.*', ['yo', 'mí', 'me', 'conmigo'], 0, '*Entre* et *según* sont les deux exceptions : elles gardent le pronom SUJET.', 'Après « entre » et « según », quel pronom emploie-t-on ?'],
...
En Castille, *le* s’emploie couramment comme COD pour une **personne masculine** : *Le vi* pour *Lo vi*. La RAE le tolère à ce seul cas ; ailleurs, on s’en tient à *lo*.`,
          ...
          questions: [
            ...
            ['*___ lo doy a mi hermano.*', ['Se', 'Le', 'Lo', 'Les'], 0, '*Le lo* n’existe pas : devant *lo/la/los/las*, *le* devient *se*.', 'Que devient « le » devant « lo » ?'],
...
Après un nom en apostrophe, le possessif tonique suit : *¡Hijo mío!*, *¡Madre mía!*`,
          ...
          questions: [
            ...
            ['*Me lavo ___ manos.*', ['las', 'mis', 'sus', 'unas'], 0, 'Le pronom réfléchi dit déjà à qui sont les mains : l’espagnol met l’ARTICLE.', 'Comment traduire « je me lave les mains » ?'],
            ...
            ['*Le duele ___ cabeza.*', ['la', 'su', 'una', 'esa'], 0, 'Même logique qu’avec *lavarse* : article, pas possessif.', 'Comment traduire « il a mal à la tête » ?'],
...
Pour reprendre une **idée entière** : *Llegó tarde, lo que me molestó*. Reprendre une phrase par *el que* est une faute.`,
          ...
          questions: [
            ...
            ['*La chica con ___ hablo es mi prima.*', ['quien', 'que', 'cuyo', 'donde'], 0, 'Après préposition et pour une personne : *quien*.', 'Quel relatif s’emploie uniquement pour des personnes ?'],
            ...
            ['*¿___ es este libro?* — « à qui est-ce ? »', ['De quién', 'Cuyo', 'Qué de', 'Quién de'], 0, '*Cuyo* ne s’emploie JAMAIS en question : c’est un relatif.', 'Comment demander « à qui est-ce ? »'],
...
*cada vez más / cada vez menos* : *Hace cada vez más calor*.`,
          ...
          questions: [
            ['*Es ___ alto como tú.*', ['tan', 'tanto', 'más', 'muy'], 0, '*Tan* devant un adjectif, *tanto* devant un nom.', 'Comment traduire « aussi grand que toi » ?'],
            ['*Tengo ___ libros como tú.*', ['tantos', 'tan', 'tanto', 'más'], 0, 'Devant un nom, *tanto* s’accorde : *tantos libros*.', 'Comment traduire « autant de livres que toi » ?'],
            ...
            ['*Este resultado es ___ que el anterior.*', ['peor', 'más malo', 'menor', 'mal'], 0, 'Comparatif irrégulier, comme *bueno → mejor*.', 'Quel est le comparatif de « malo » ?'],
...
*sumamente*, *extremadamente*, et les préfixes familiers *super-*, *requete-* : *un examen super difícil*.`,
          ...
          questions: [
            ['*Es el edificio más alto ___ mundo.*', ['del', 'en el', 'de el', 'al'], 0, 'Le complément du superlatif se met avec *de*, jamais *en* — et *de + el* se contracte.', 'Comment traduire « le plus grand du monde » ?'],
            ['« Muy guapísimo » est une tournure correcte.', ['Vrai', 'Faux'], 1, 'On emploie *muy* OU le suffixe -ísimo, jamais les deux.'],
            ['*Es un país ___* — « très riche ».', ['riquísimo', 'ricísimo', 'rikísimo', 'ricoísimo'], 0, 'Le *c* devient *qu* devant le suffixe pour garder le son [k].', 'Quel est le superlatif absolu de « rico » ?'],
...
Et le sens change avec la place : *gran* devant = important ; *grande* derrière = de grande taille.`,
          ...
          questions: [
            ['*Es un ___ amigo.*', ['buen', 'bueno', 'buena', 'bue'], 0, '*Bueno* s’apocope en *buen* devant un nom masculin singulier.', 'Quelle est la forme apocopée de « bueno » devant un nom masculin ?'],
            ...
            ['*Cuesta ___ euros.*', ['cien', 'ciento', 'cientos', 'cienes'], 0, '*Ciento* s’apocope en *cien* devant un nom : *cien euros*, mais *ciento veinte*.', 'Comment dit-on « cent euros » ?'],
