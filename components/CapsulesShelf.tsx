...
import { Clock, Gift, Lock, ChevronRight } from 'lucide-react'
...
/**
 * Les capsules d'apprentissage (mini-formations vidéo du coach, la première
 * offerte) — déménagées de la Boutique vers le volet Premium : tout ce qui
 * coûte des EUROS vit ici, la Boutique ne parle plus que pièces.
 */
export default function CapsulesShelf() {
  return (
    <section aria-labelledby="premium-capsules" className="mx-auto w-full max-w-md">
      <div className="mb-3 px-1">
        ...
        <p className="mt-0.5 text-xs text-muted-foreground">
          Les mini-formations en vidéo du coach — la première est offerte.
        </p>
      </div>
