...
Dernier réflexe à prendre : *its* (le possessif) ne prend **pas d’apostrophe**. *It’s* avec apostrophe est la contraction de *it is*.`,
          ...
          questions: [
            ...
            ['*She is ___ best student in the class.*', ['the', 'a', 'an', 'some'], 0, 'Le superlatif est unique par définition : il appelle l’article défini.', 'Devant un superlatif, on emploie…'],
          ],
        },
        {
...
| **too much / too many** | Avant le nom | *too much noise*, *too many people* |`,
          ...
          questions: [
            ['*He hasn’t got ___ money left.*', ['much', 'many', 'a few', 'several'], 0, '*Money* est indénombrable : *much*. *Many* compte des unités.', 'Quel quantifieur s’emploie avec un indénombrable ?'],
            ...
            ['*Have you got ___ money?*', ['any', 'some', 'much of', 'a lot'], 0, '*Any* dans les questions et les négations, *some* dans les affirmations.', 'Dans une question, on emploie normalement…'],
            ['« The news is good » est correct.', ['Vrai', 'Faux'], 0, '*News* est un indénombrable singulier malgré son -s.'],
            ['*He isn’t ___ to vote.*', ['old enough', 'enough old', 'enough', 'old'], 0, '*Enough* se place APRÈS l’adjectif — l’inverse du français.', 'Où se place « enough » avec un adjectif ?'],
...
*The rich are getting richer* — jamais *is*.`,
          ...
          questions: [
            ...
            ['*She drives ___ car.*', ['a big red Italian', 'a red big Italian', 'an Italian red big', 'a big Italian red'], 0, 'Ordre : taille, puis couleur, puis origine.', 'Quel est l’ordre correct ?'],
...
C’est pourquoi *Like you tea?* est impossible : il faut un auxiliaire à porter devant, donc *Do you like tea?*`,
          ...
          questions: [
            ...
            ['*___ cold — could you close the window?*', ['I am', 'I have', 'I have got', 'It makes me'] , 0, 'L’anglais ÊTRE là où le français A : *I am cold*, *I am hungry*, *I am 17*.', 'Comment traduit-on « J’ai froid » ?'],
...
| *can’t have* + participe | Déduction négative | *He can’t have seen us* |`,
          ...
          questions: [
            ['*You must ___ now.*', ['leave', 'to leave', 'leaving', 'left'], 0, 'Un modal est suivi de la BASE VERBALE, sans *to* et sans -s.', 'Quelle forme suit un modal ?'],
...
Vouloir la remettre devant (*For whom are you waiting?*) donne un anglais correct mais très formel, qu’on n’emploie ni à l’oral ni dans un essai.`,
          ...
          questions: [
            ['*Don’t ___ — you’re almost there.*', ['give up', 'give away', 'get up', 'give back'], 0, 'La particule change tout le sens : *give up* = abandonner.', 'Que signifie « give up » ?'],
            ['« Turn on it » est correct pour « allume-la ».', ['Vrai', 'Faux'], 1, 'Un pronom s’intercale obligatoirement : *turn it on*.'],
            ['*Could you ___ my cat while I’m away?*', ['look after', 'look for', 'look at', 'look like'], 0, '*Look after* = s’occuper de ; *look for* = chercher.', 'Que signifie « look after » ?'],
            ...
            ['*The meeting was ___ until Monday.*', ['put off', 'put on', 'put out', 'put up'], 0, '*Put off* = reporter ; *put out* = éteindre.', 'Que signifie « put off » ?'],
            ['*___ the word in a dictionary.*', ['Look up', 'Look for', 'Look at', 'Look after'], 0, '*Look up* = chercher dans un ouvrage de référence.', '« Look up a word » signifie…'],
          ],
        },
        {
...
> *I stopped smoking* (j’ai arrêté de fumer) et *I stopped to smoke* (je me suis arrêté pour fumer) disent **le contraire** l’un de l’autre. Ce n’est pas une nuance de style.`,
          ...
          questions: [
            ['*She left without ___ goodbye.*', ['saying', 'to say', 'say', 'said'], 0, 'Après une PRÉPOSITION, toujours la forme en -ING.', 'Quelle forme suit une préposition ?'],
            ['« I look forward to see you » est correct.', ['Vrai', 'Faux'], 1, 'Ici *to* est une préposition : *to seeing you*.'],
            ['*I ___ reading before bed.*', ['enjoy', 'decide', 'want', 'promise'], 0, '*Enjoy* appelle -ING ; *decide*, *want* et *promise* appellent *to*.', 'Quel verbe est suivi de -ING ?'],
            ...
            ['*He avoids ___ about it.*', ['talking', 'to talk', 'talk', 'talked'], 0, '*Avoid*, *mind*, *suggest*, *practise* : tous suivis de -ING.', 'Après « avoid », on emploie…'],
...
Placé en tête, il commente tout l’énoncé et se détache par une virgule : *Unfortunately, they lost.* · *Obviously, he was lying.*`,
          ...
          questions: [
            ['*She could ___ hear him.*', ['hardly', 'hard', 'hardily', 'strongly'], 0, 'Faux ami classique : *hardly* = à peine, PAS « durement » (*hard*).', 'Que signifie « hardly » ?'],
            ...
            ['*She smiled ___.*', ['happily', 'happyly', 'happly', 'happier'], 0, 'Le -y final devient -i devant -ly.', 'Quel est l’adverbe formé sur « happy » ?'],
            ['*This one is ___ better.*', ['much', 'very', 'more', 'so'], 0, '*Very* ne renforce jamais un comparatif : c’est *much* (ou *far*).', 'Comment dit-on « bien meilleur » ?'],
            ['« Fast » a la même forme comme adjectif et comme adverbe.', ['Vrai', 'Faux'], 0, 'Comme *hard*, *late*, *early*.'],
            ['*I haven’t seen him ___.*', ['lately', 'late', 'later', 'lastly'], 0, '*Lately* = récemment. Pour « en retard », c’est *late*.', '« Lately » signifie…'],
          ],
        },
...
Et le présent en -ING sert au **futur programmé** : *We’re leaving tomorrow*.`,
          ...
          questions: [
            ...
            ['*When he ___, I’ll call you.*', ['arrives', 'will arrive', 'would arrive', 'arrived'], 0, 'Après *when*, *as soon as*, *until* : présent, jamais *will*.', 'Comment traduit-on « Quand il arrivera, je t’appellerai » ?'],
            ['« We’re leaving tomorrow » exprime un futur programmé.', ['Vrai', 'Faux'], 0, 'BE + -ING sert couramment au futur planifié.'],
            ['*He ___ in London.*', ['works', 'work', 'working', 'worked'], 0, 'Le -s de la 3e personne du singulier au présent simple.', 'À la 3e personne du singulier, le présent simple prend…'],
...
Un fait **daté** ne se met jamais au present perfect. *I have seen him yesterday* est faux : dès qu’un repère de temps passé est présent, c’est le prétérit.`,
          ...
          questions: [
            ...
            ['*He ___ the bus yesterday.*', ['took', 'taked', 'taken', 'takes'], 0, 'Verbe irrégulier : *take – took – taken*.', 'Quel est le prétérit de « take » ?'],
...
| Autre exemple | *He has cried* | *You’ve been crying* (j’en vois les traces) |`,
          ...
          questions: [
            ...
            ['*I have lived here ___ 2019.*', ['since', 'for', 'from', 'during'], 0, '*Since* + point de départ, *for* + durée. Et le français « depuis » se dit au present perfect.', 'Comment traduit-on « Je vis ici depuis 2019 » ?'],
            ...
            ['*I have ___ finished my homework.*', ['already', 'yesterday', 'last week', 'in 2010'], 0, 'Un repère de temps ACHEVÉ interdit le present perfect : il appelle le prétérit.', 'Quel marqueur va avec le present perfect ?'],
...
| Le **discours indirect** | Present perfect et prétérit deviennent past perfect | « *I have finished* » → *He said he had finished* |`,
          ...
          questions: [
            ['*When I arrived, the train ___ already left.*', ['had', 'have', 'has', 'was'], 0, 'Le past perfect : *had* + participe passé, pour le fait le plus ancien.', 'Comment se forme le past perfect ?'],
            ...
            ['*He ___ gone before we arrived.*', ['had', 'would', 'did', 'should'], 0, 'Le participe passé qui suit tranche : après *would*, on aurait la base verbale.', 'Dans « he’d gone », la contraction ’d correspond à…'],
          ],
        },
        {
...
*If I would have money* est une faute lourde : la subordonnée en *if* ne prend **ni** *will* **ni** *would*. Le temps recule d’un cran dans la subordonnée, et *would* reste dans la principale.`,
          ...
          questions: [
            ...
            ['*I’ll call you when I ___ home.*', ['get', 'will get', 'would get', 'got'], 0, 'Deux futurs français, un seul futur anglais : la subordonnée reste au présent.', 'Comment traduit-on « Je t’appellerai quand je rentrerai » ?'],
